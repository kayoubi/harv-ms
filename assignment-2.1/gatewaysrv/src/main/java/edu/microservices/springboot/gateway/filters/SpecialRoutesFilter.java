...
import edu.microservices.springboot.gateway.model.AbTestingRoute;
...
public class SpecialRoutesFilter extends ZuulFilter {
    ...
    public SpecialRoutesFilter(RestTemplate restTemplate) {
    ...
    private String buildRouteString(String oldEndpoint, String newEndpoint, String serviceName){
        ...
        logger.debug("Target route: {}/{}", newEndpoint, strippedRoute);
    ...
    private void forwardToSpecialRoute(String route) {
        ...
        try (CloseableHttpClient httpClient = HttpClients.createDefault()) {
            response = forward(httpClient, verb, route, request, headers, getRequestBody(request));
    ...
    private Header[] convertHeaders(MultiValueMap<String, String> headers) {
        return (Header[]) headers
            .keySet()
            .stream()
            .map((Function<String, List<Header>>) s -> headers.get(s)
                .stream()
                .map(v -> new BasicHeader(s, v))
